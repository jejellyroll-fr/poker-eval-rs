use crate::deck_std::{STD_DECK_SUIT_HEARTS, STD_DECK_SUIT_DIAMONDS, STD_DECK_SUIT_CLUBS, STD_DECK_SUIT_SPADES};
use crate::t_cardmasks::{ StdDeckCardMask, STD_DECK_CARD_MASKS_TABLE};
use crate::t_botfivecards::{BOTTOM_FIVE_CARDS_TABLE};
use crate::handval_low::{LowHandVal, LOW_HAND_VAL_WORST_EIGHT, LOW_HAND_VAL_NOTHING, 
    TOP_CARD_MASK, TOP_CARD_SHIFT, SECOND_CARD_MASK, SECOND_CARD_SHIFT, 
    THIRD_CARD_MASK, THIRD_CARD_SHIFT, FOURTH_CARD_MASK, FOURTH_CARD_SHIFT, 
    FIFTH_CARD_MASK, FIFTH_CARD_SHIFT};
...
fn std_deck_lowball8_eval(cards: StdDeckCardMask, _n_cards: i32) -> LowHandVal {
    ...
    let ranks = card_mask & ((STD_DECK_SUIT_HEARTS as u64) | 
    ...
    if retval > 0 && retval <= LOW_HAND_VAL_WORST_EIGHT {
        ...
        LowHandVal::new(HandType::NoPair as u8, top_card, second_card, third_card, fourth_card, fifth_card)
    } else {
